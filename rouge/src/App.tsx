...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-full z-50 transition-all duration-300 flex flex-col">
      {/* Top Bar */}
      <div
        className={`bg-[#E53935] text-white transition-all duration-300 overflow-hidden ${isScrolled ? "h-0 opacity-0" : "h-10 opacity-100"}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex justify-between items-center text-xs font-medium">
          <div className="flex items-center gap-4 sm:gap-6">
            <span className="flex items-center gap-2">
              <Phone size={14} />{" "}
              <span className="hidden sm:inline">+229 95 22 48 34</span>
              <span className="sm:hidden">Appeler</span>
            </span>
            <span className="hidden md:flex items-center gap-2">
              <Mail size={14} /> cstbsn@yahoo.fr
            </span>
          </div>
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-1 cursor-pointer hover:text-red-200 transition-colors">
              <Globe size={14} />{" "}
      ...
      {/* Main Nav */}
      <div
        className={`bg-white transition-all duration-300 ${isScrolled ? "shadow-md" : "border-b border-gray-100"}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8 text-sm font-bold text-gray-600 uppercase tracking-wide h-full">
            <NavItem href="/" isHome={isHome}>
              ACCUEIL
            </NavItem>
            <NavItem href="/qui-sommes-nous" isHome={isHome}>
              QUI SOMMES-NOUS
            </NavItem>
            <NavItem href="/actualites" isHome={isHome}>
              ACTUALITÉS
            </NavItem>
            ...
            <Link
              to="/vote"
              className="bg-red-600 text-white px-5 py-2.5 rounded-sm font-bold hover:bg-red-700 transition-colors flex items-center gap-2 ml-4 shadow-sm"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-8 tracking-tight">
            Notre Histoire, <br />
            <span className="text-red-600">Notre Combat</span>
          </h2>
          <div className="space-y-6 text-gray-600 text-lg font-light leading-relaxed">
            <p>
              Créée en{" "}
              <strong className="text-gray-900 font-bold">avril 1982</strong>{" "}
              sous l'égide du Parti Communiste du Dahomey (PCD), la CSTB s'est
              forgée en rempart contre l'impérialisme en pleine période
              d'opportunisme.
            </p>
            <p>
              Nous avons toujours refusé les compromis et les alliances
              opportunistes qui menaçaient le mouvement ouvrier. En{" "}
              <strong className="text-gray-900 font-bold">octobre 2000</strong>,
              à l'issue de notre 3ème congrès ordinaire, nous sommes devenus une
              Confédération, marquant notre statut d'acteur central dans la
              lutte.
            </p>
            <div className="p-8 bg-white border-l-4 border-red-600 mt-10 shadow-sm">
              <p className="italic text-gray-800 text-xl font-display">
                "La ligne de la CSTB, c'est une ligne de conduite générale qui
                œuvre ardemment à l'amélioration constante des conditions de vie
        ...
        >
          ...
          <div className="absolute -bottom-6 -left-4 md:-bottom-10 md:-left-10 bg-red-600 p-6 md:p-10 shadow-2xl">
            <p className="text-4xl md:text-6xl font-display font-black text-white">
              40+
            </p>
            <p className="text-red-100 font-medium mt-2 text-sm md:text-lg">
              Années de lutte
              <br />
              syndicale
            </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 w-full">
        {missions.map((mission, index) => (
          ...
          >
            ...
            {/* Color Overlay */}
            <div
              className={`absolute inset-0 ${mission.overlay} transition-opacity duration-300`}
            ></div>
            ...
            <div className="absolute inset-0 p-10 md:p-12 flex flex-col justify-center text-white z-10">
              ...
              <div className="mt-auto md:mt-0">
                <Link
                  to="/qui-sommes-nous"
                  className="inline-block bg-white text-gray-900 font-bold px-8 py-3 rounded-full hover:bg-gray-100 transition-colors shadow-lg text-sm uppercase tracking-wider"
                >
                  {mission.buttonText}
                </Link>
              </div>
...
const Organization = () => (
  <section
    id="organisation"
    className="py-32 bg-gray-50 text-gray-900 border-y border-gray-200"
  >
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-10 tracking-tight">
            Direction & <span className="text-red-600">Structure</span>
          </h2>
          <div className="bg-white p-10 border border-gray-200 mb-10 relative overflow-hidden group shadow-sm">
            ...
            <p className="text-red-600 font-medium mb-6 tracking-wide uppercase text-sm">
              Secrétaire Général Confédéral
            </p>
            <p className="text-gray-600 font-light leading-relaxed">
              Figure emblématique de la CSTB, reconduit à la tête du Comité
              Confédéral National (CCN) pour 5 ans lors du 6ème congrès
              ordinaire du 25 août 2023. Son adjoint est Kouto Norbert.
            </p>
          </div>
          <p className="text-gray-700 text-xl font-light leading-relaxed">
            La CSTB est reconnue comme la{" "}
            <strong className="text-gray-900 font-bold">
              première organisation de représentation des travailleurs
            </strong>{" "}
            à la 3ème édition des élections professionnelles nationales.
          </p>
        </div>

        <div>
          <h3 className="text-2xl font-display font-bold mb-8">
            Syndicats Affiliés Majeurs
          </h3>
          <div className="space-y-4">
            {[
              {
                abbr: "SYNTRACMEE",
                full: "Syndicat National des Travailleurs de l'Administration Centrale des Mines, de l'Énergie et de l'Eau",
              },
              {
                abbr: "SYNAHAB",
                full: "Syndicat National des Assistants d'Hygiène et d'Assainissement du Bénin",
              },
              {
                abbr: "FéSEN/CSTB",
                full: "Fédération des syndicats de l'éducation nationale",
              },
              {
                abbr: "FESYNTRA-FINANCES",
                full: "Fédération des Syndicats des Travailleurs des Finances",
              },
            ].map((syndicat, idx) => (
              <motion.div
                key={idx}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24">
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 tracking-tight">
            Luttes & <span className="text-red-600">Actions Récentes</span>
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-xl font-light">
            Sur le terrain, face à l'adversité, la CSTB ne recule jamais pour
            ...
            {actions.map((action, index) => (
              ...
              >
                <div className="w-full md:w-5/12 mb-8 md:mb-0">
                  <div
                    className={`p-8 bg-gray-50 border border-gray-200 hover:border-red-600/50 transition-colors shadow-sm ${index % 2 === 0 ? "md:text-left" : "md:text-right"}`}
                  >
                    <span className="text-red-600 font-bold text-sm mb-3 block tracking-wider uppercase">
                      {action.date}
                    </span>
        ...
        <div className="flex w-max animate-marquee items-center">
          {duplicatedPartners.map((partner, index) => (
            ...
            >
              ...
              />
              {partner.name && (
                <span className="text-xl font-display font-bold text-gray-800 whitespace-nowrap">
                  {partner.name}
                </span>
              )}
            </div>
...
const Footer = () => (
  <footer
    id="contact"
    className="bg-gray-100 text-gray-900 py-16 border-t border-gray-200"
  >
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
        <div>
          <div className="flex items-center mb-8">
            <img src={mainLogo} alt="CSTB Bénin Logo" className="h-16 w-auto" />
          </div>
          <p className="text-gray-600 font-light leading-relaxed mb-6">
            Confédération Syndicale des Travailleurs du Bénin. Affiliée à la
            Confédération syndicale internationale (CSI).
          </p>
        </div>

        <div>
          <h4 className="text-xl font-display font-bold mb-8">
            Nous Contacter
          </h4>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-600 font-light">
            <li>
              <a
                href="https://cstbbenin.org"
                target="_blank"
                rel="noreferrer"
                className="hover:text-red-600 transition-colors flex items-center gap-2"
              >
                <ChevronRight size={16} /> Site Web Officiel
              </a>
            </li>
            <li className="flex items-center gap-2">
              <ChevronRight size={16} /> Plateforme éducative (Soutien
              Backup/UNESCO)
            </li>
            <li className="flex items-center gap-2">
              <ChevronRight size={16} /> Forum WhatsApp Enseignants
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 mt-16 pt-8 text-center text-gray-500 text-sm font-light">
        <p>
          &copy; {new Date().getFullYear()} CSTB Bénin. Tous droits réservés.
        </p>
      </div>
    </div>
  </footer>
...
const News = () => {
  ...
  return (
    <section
      id="actualites"
      className="py-32 bg-white text-gray-900 border-b border-gray-200"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <h2 className="text-4xl md:text-5xl font-display font-bold tracking-tight mb-4">
              Dernières <span className="text-red-600">Actualités</span>
            </h2>
            <p className="text-gray-600 text-xl font-light max-w-2xl">
              Restez informés des dernières luttes, victoires et communications
              de la CSTB.
            </p>
          </div>
          <Link
            to="/actualites"
            className="inline-flex items-center gap-2 font-bold text-red-600 hover:text-red-800 transition-colors group"
          >
          ...
          {newsItems.map((item, index) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <span className="text-gray-500 text-sm font-mono mb-3">
                  {item.date}
                </span>
                <h3 className="text-xl font-display font-bold mb-3 group-hover:text-red-600 transition-colors line-clamp-2">
                  {item.title}
                </h3>
                ...
                <Link
                  to={`/actualites/${index + 1}`}
                  className="inline-flex items-center gap-2 text-sm font-bold text-gray-900 group-hover:text-red-600 transition-colors mt-auto"
                >
